...
algebraic data types, which are our main way of modelling data. We turn to
codata in @sec:codata, which is the opposite, or dual, or algebraic data. Type
classes are the focus on @sec:type-classes, while fundamentals of interpreters
are discussed in @sec:interpreters. These four strategies all describe code
