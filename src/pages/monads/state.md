...
// a: cats.data.State[Int,String] = cats.data.StateT@780bcd69
```
...
// step1: cats.data.State[Int,String] = cats.data.StateT@65a95f49

val step2 = State[Int, String] { num =>
  val ans = num * 2
  (ans, s"Result of step2: $ans")
}
// step2: cats.data.State[Int,String] = cats.data.StateT@51f0187e

val both = for {
  a <- step1
  b <- step2
} yield (a, b)
// both: cats.data.StateT[cats.Eval,Int,(String, String)] = cats.data.StateT@66201bf5
...
// step1: cats.data.State[Int,Int] = cats.data.StateT@25869133

val step2 = State.set[Int](30)
// step2: cats.data.State[Int,Unit] = cats.data.StateT@28ce86d4

val step3 = State.pure[Int, String]("Result")
// step3: cats.data.State[Int,String] = cats.data.StateT@20ea0b1

val step4 = State.inspect[Int, String](_ + "!")
// step4: cats.data.State[Int,String] = cats.data.StateT@3f70362e

val step5 = State.modify[Int](_ + 1)
// step5: cats.data.State[Int,Unit] = cats.data.StateT@78a9b514
...
// program: cats.data.State[Int,(Int, Int, Int)] = cats.data.StateT@1516b659
...
// program: cats.data.StateT[cats.Eval,List[Int],Int] = cats.data.StateT@28025e13
