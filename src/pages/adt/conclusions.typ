#import "../stdlib.typ": href, narrative-cite
== Conclusions
...
I learned about both from #narrative-cite(<felleisen18:htdp>).
...
The infamous #narrative-cite(<meijer91:bananas>) is an example of such work.
...
The earliest reference I've found to structural recursion is #narrative-cite(<burstall69:proving>).
...
Corecursion is a bit better documented in the contemporary literature. #narrative-cite(<gibbons21:htdcp>) covers the main ideas we have looked at here, while #narrative-cite(<gibbons98:unfold>) discusses uses of `unfold`.

#narrative-cite(<mcbride01:deriv>) describes the derivative of algebraic data types.
