...
// booleanAndMonoid: cats.Monoid[Boolean] = $anon$1@53df3598
```
...
// booleanOrMonoid: cats.Monoid[Boolean] = $anon$1@709f7153
```
...
// booleanXorMonoid: cats.Monoid[Boolean] = $anon$1@37b9c905
```
...
// booleanXnorMonoid: cats.Monoid[Boolean] = $anon$1@1d1ef233
```
...
// intSetMonoid: algebra.Monoid[Set[Int]] = $anon$1@70bf0ea1
```
